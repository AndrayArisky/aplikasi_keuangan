...
class _labaRugiState extends State<labaRugi>
  ...
  void fetchData() async {
    final response = await http.get(
        Uri.parse('http://apkeu2023.000webhostapp.com/getTransaksi.php'));
                        ...
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            ...totalBeban.entries
                                ...
                                .toList(),
                            Divider(),
                            _buildTotalRow('Total Beban',
                                '${rupiah.format(totalBeban.values.fold(0, (a, b) => a + b))}'),
                            Divider(),
      ...
      transactions.forEach((transaction) {
        ...
        if (grup == 'Pendapatan') {
          totalPendapatan[namaTransaksi] =
              (totalPendapatan[namaTransaksi] ?? 0) + nilaiTransaksi;
        } else if (grup == 'Beban') {
          totalBeban[namaTransaksi] =
              (totalBeban[namaTransaksi] ?? 0) + nilaiTransaksi;
        }
      });
                ...
                pw.TableRow(
                  children: [
                    ...
                    pw.Container(
                      ...
                      alignment: pw.Alignment.centerRight,
                      child: pw.Text(
                          rupiah.format(totalBeban.values.fold(
                              0, (a, b) => a + b)),
                          style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
                    )
                  ],
