                      ...
                      child: SingleChildScrollView(
                        child: Column(
                          ...
                          children: <Widget>[
                            ...
                            ...totalPendapatan.entries.map((entry) => _buildAkunRow(entry.key,'${rupiah.format(entry.value)}')).toList(),
                            Divider(),
                            ...
                            _buildItemRow('Beban'),
                            SizedBox(height: 10.0),
                            ...totalBeban.entries.map((entry) => _buildAkunRow(entry.key,'${rupiah.format(entry.value)}')).toList(),
                            Divider(),
