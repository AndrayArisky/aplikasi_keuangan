...
class liabilitas extends StatefulWidget {
  @override
  liabilitasState createState() => liabilitasState();
}

class liabilitasState extends State<liabilitas> {
  List<dynamic> Data = [];
  ...
  Future<void> fetchData() async {
    ...
    if (response.statusCode == 200) {
      ...
      final akun = jsonData.where((data) => data['neraca'] == 'Liabilitas (Kewajiban)').toList();
      setState(() {
        Data = akun;
      });
    } else {
