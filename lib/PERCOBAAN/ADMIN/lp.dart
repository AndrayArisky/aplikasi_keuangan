...
//                       alignment: pw.Alignment.centerRight,
//                       child: pw.Text(
//                           rupiah.format(totalGrupAset.values.fold(0, (a, b) => a + b)),
//                           style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
//                     )
//                   ],
//                 ),
...
//                 pw.TableRow(children: [
//                   pw.Container(
//                     padding: pw.EdgeInsets.only(right: 8, top: 10),
//                     child: pw.Text('Total Liabilitas Jangka Pendek',
//                         style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
//                   ),
//                   pw.Container(
//                     padding: pw.EdgeInsets.only(left: 8, top: 10),
//                     alignment: pw.Alignment.centerRight,
//                     child: pw.Text(
...
//                 pw.TableRow(children: [
//                   pw.Container(
//                     padding: pw.EdgeInsets.only(right: 8, top: 15),
//                     child: pw.Text('Total Keseluruhan Liabilitas (Kewajiban)',
//                         style: pw.TextStyle(fontWeight: pw.FontWeight.bold)),
//                   ),
//                   pw.Container(
//                     padding: pw.EdgeInsets.only(left: 8, top: 15),
//                     alignment: pw.Alignment.centerRight,
//                     child: pw.Text(
//                       rupiah.format(totalGrupLiabilitas.values.fold(0, (a, b) => a + b)),
//                       style: pw.TextStyle(fontWeight: pw.FontWeight.bold)
//                   ),
//                   )
//                 ]), 
